...
class TracingLocalPush {
    ...
    private let notificationIdentifier3 = "notification.syncWarning3"

    private let timeInterval1: TimeInterval = 60 * 60 * 24 * 2 // Two days
    //private let timeInterval1: TimeInterval = 60 * 2 // Two minute
    private let timeInterval2: TimeInterval = 60 * 60 * 24 * 7 // Seven days
    //private let timeInterval2: TimeInterval = 60 * 7 // Seven days
    private let timeInterval3: TimeInterval = 60 * 60 * 24 * 6 // Seven days
    ...
    func resetSyncWarningTriggers() {
        ...
        content2.title = " "
        content2.body = "Averigua si has tenido un contacto riesgoso, abre la aplicación"
        
        let content3 = UNMutableNotificationContent()
        content3.title =  " "
        content3.body = "Recuerda reportarte como contagiado si resultas con un prueba positiva de COVID-19"
        ...
        let trigger3 = UNTimeIntervalNotificationTrigger(timeInterval: timeInterval3, repeats: true)
