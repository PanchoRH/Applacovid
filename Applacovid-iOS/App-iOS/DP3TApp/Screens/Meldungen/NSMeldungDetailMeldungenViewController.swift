...
class NSMeldungDetailMeldungenViewController: NSTitleViewScrollViewController {
    ...
    private func setupLayout() {
        ...
        /*stackScrollView.addArrangedView(NSOnboardingInfoView(icon: UIImage(named: "ic-call")!.ub_image(with: .ns_purple), text: "meldungen_meldungen_faq1_text".ub_localized, title: "meldungen_meldungen_faq1_title".ub_localized, leftRightInset: 0))
    ...
    private func makeNotYetCalledView() -> NSSimpleModuleBaseView {
        let whiteBoxView = NSSimpleModuleBaseView(title: "meldungen_detail_call".ub_localized, subtitle: "meldung_detail_positive_test_box_subtitle".ub_localized, boldText: "infoline_tel_number".ub_localized, text: " ", image: UIImage(named: "illu-anrufen"), subtitleColor: .ns_purple)

        whiteBoxView.contentView.addSpacerView(NSPadding.medium)

        let callButton = NSButton(title: "meldungen_detail_call_button".ub_localized, style: .uppercase(.ns_purple))
    ...
    private func makeAlreadyCalledView() -> NSSimpleModuleBaseView {
        /*let whiteBoxView = NSSimpleModuleBaseView(title: "meldungen_detail_call_thankyou_title".ub_localized, subtitle: "meldungen_detail_call_thankyou_subtitle".ub_localized, text: "meldungen_detail_guard_text".ub_localized, image: UIImage(named: "illu-verhalten"), subtitleColor: .ns_purple)*/
        let whiteBoxView = NSSimpleModuleBaseView(title: "meldungen_detail_call".ub_localized, subtitle: "meldung_detail_positive_test_box_subtitle".ub_localized, boldText: "infoline_tel_number".ub_localized, text: " ", image: UIImage(named: "illu-anrufen"), subtitleColor: .ns_purple)
        whiteBoxView.contentView.addSpacerView(NSPadding.medium)

        /*let callButton = NSButton(title: "meldungen_detail_call_again_button".ub_localized, style: .outlineUppercase(.ns_purple))*/
        let callButton = NSButton(title: "meldungen_detail_call_button".ub_localized, style: .uppercase(.ns_purple))
        callButton.touchUpCallback = { [weak self] in
            guard let strongSelf = self else { return }
            strongSelf.call()
    ...
    private func makeCallAgainView() -> NSSimpleModuleBaseView {
        let whiteBoxView = NSSimpleModuleBaseView(title: "meldungen_detail_call_again".ub_localized, subtitle: "meldung_detail_positive_test_box_subtitle".ub_localized, boldText: "infoline_tel_number".ub_localized, text: "meldungen_detail_guard_text".ub_localized, image: UIImage(named: "illu-anrufen"), subtitleColor: .ns_purple)
    ...
    private func createExternalLinkButton() -> NSExternalLinkButton {
        let button = NSExternalLinkButton(color: .ns_purple)
