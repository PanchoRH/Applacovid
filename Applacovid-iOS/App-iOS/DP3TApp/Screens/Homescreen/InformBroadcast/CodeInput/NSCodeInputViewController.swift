...
class NSCodeInputViewController: NSInformStepViewController, NSCodeControlProtocol {
    ...
    private let errorTitleLabel = NSLabel(.uppercaseBold, textColor: .ns_purple, textAlignment: .center)
    private let errorTextLabel = NSLabel(.textLight, textColor: .ns_purple, textAlignment: .center)
