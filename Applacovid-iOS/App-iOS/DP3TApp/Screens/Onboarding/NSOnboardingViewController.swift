...
class NSOnboardingViewController: NSViewController {
    ...
    private let continueButton = NSSimpleTextButton(title: "onboarding_continue_button".ub_localized, color: .ns_purple)
    private let finishButton = NSButton(title: "onboarding_finish_button".ub_localized, style: .normal(.ns_purple))
