...
struct NSOnboardingStepModel {
    ...
    static let step2 = NSOnboardingStepModel(heading: "onboarding_privacy_heading".ub_localized,
                                             ...
                                             textGroups: [
                                                 (UIImage(named: "ic-tracing-onboarding")!, "onboarding_privacy_text1".ub_localized),
                                                 (UIImage(named: "ic-lock")!, "onboarding_privacy_text2".ub_localized),
                                                 (UIImage(named: "ic-key")!, "Es imposible para Applacovid relacionar tu identidad con los mensajes aleatorios"),
                                             ])
